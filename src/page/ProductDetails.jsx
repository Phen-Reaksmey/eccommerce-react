...
import p from "../components/asset/images/cat-item1.jpg";
//import p2 from "../components/asset/images/cat-item2.jpg";
        ...
        <div class="collection-item d-flex flex-wrap my-5">
          <div class="col-md-6 column-container">
            <div class="image-holder">
              <img src={p} alt="collection" class="product-image img-fluid" />
            </div>
          </div>
